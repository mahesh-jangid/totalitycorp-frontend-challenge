    ...
    <div>
      ...
      <section className="hs-part1">
        ...
        <div className="main1">
          ...
          <div className="div3">
            <p>
              From ₹59900<sup>*</sup> before trade-in
            </p>
          </div>
          <div className="div4">
            <a href="# ">
            ...
            <a className="a1" href="# ">
              {" "}
              Order now<i uk-icon="chevron-right"></i>
            </a>
          </div>
        </div>
        <div className="div5">
      ...
      <section className="hs-part2">
        <div className="main1">
          ...
          <div className="div3">
            <p>
              From ₹119900<sup>*</sup> before trade-in
            </p>
          </div>
          <div className="div4">
            <a href="# ">
      ...
      <section className="hs-part4">
        <div className="main1">
          ...
          <div className="div3">
            <div className="sub1">
              <h4>
                Buy a Mac or iPad for university. Get&nbsp;AirPods.<sup>1</sup>
              </h4>
            </div>
            <div className="sub2">
              <a href="# ">
                Save with education pricing<i uk-icon="chevron-right"></i>
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="hs-part6 hs-part5 hs-part4">
        ...
        <div className="main2">
          ...
          <div className="div3 coda">
            ...
            <div className="sub3">
              <a href="# ">
                Stream now <i uk-icon="play-circle"></i>
              </a>
            </div>
          </div>
        </div>
